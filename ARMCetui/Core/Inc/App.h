...
#define B_OUTPUT_SHAFT_PULSES_PER_REVOLUTION    (J_ENCODER_TOTAL_RESOLUTION * B_REDUCTION_RATIO ) //大臂 
#define S_OUTPUT_SHAFT_PULSES_PER_REVOLUTION    (J_ENCODER_TOTAL_RESOLUTION * S_REDUCTION_RATIO )//小臂
#define W_OUTPUT_SHAFT_PULSES_PER_REVOLUTION    (J_ENCODER_TOTAL_RESOLUTION * W_REDUCTION_RATIO ) //腕部
/*臂转一圈捕获的脉冲数*/ 
