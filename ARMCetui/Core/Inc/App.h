...
#define J_ENCODER_TOTAL_RESOLUTION             (J_ENCODER_RESOLUTION * 4)// sConfig.IC1Polarity = BOTHEDGE为四
...
#define S_OUTPUT_SHAFT_PULSES_PER_REVOLUTION    (S_ENCODER_TOTAL_RESOLUTION * S_REDUCTION_RATIO )//小臂60RPM=6000000
...
#define B_ARM_PULSES_PER_REVOLUTION     (B_OUTPUT_SHAFT_PULSES_PER_REVOLUTION * B_TRANS_RATIO)  //1500000
#define S_ARM_PULSES_PER_REVOLUTION     (S_OUTPUT_SHAFT_PULSES_PER_REVOLUTION * S_TRANS_RATIO)  //1500000
