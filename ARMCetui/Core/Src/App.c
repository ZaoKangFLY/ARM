...
void System_Init()
{
	...
	pid_param_init(&Motor_Big,POSITION_PID,500.0f,200.0f,2.1f,1.0f,0.0f,10000.0f,0.001f);//初始化大臂PID结构体
	pid_param_init(&Motor_Small,POSITION_PID,999.0f,200.0f,2.1f,1.0f,0.0f,10000.0f,1000.0f);//初始化小臂PID结构体 
