...
void Init_data_array(uint8_t *data)     //数组初始化
{
    int i = 0;
    while (data[i++] != 0)
    {
...
void Receive_Data(uint8_t str, uint8_t* Data)
{
    ...
    case 5:
        ...
        {
            pUartHandle.aRxBuf_1[pUartHandle.aRxBufIndex] = str;
            memcpy(Data, pUartHandle.aRxBuf_1, sizeof(pUartHandle.aRxBuf_1));
...
//        {
//            pUartHandle.aRxBuf_1[pUartHandle.aRxBufIndex++] = str;
//            memcpy(Data, pUartHandle.aRxBuf_1, sizeof(pUartHandle.aRxBuf_1)-1);
//			pUartHandle.step++;
//            //Init_data_array(pUartHandle.aRxBuf_1);  //每收完一帧数据后缓冲区清零。防止溢出
//            //pUartHandle_init();                       //初始化
//			//pUartHandle.Done=1;
...
//    case 8:
//	    pUartHandle.step++;
//		pUartHandle.LenCnt_2 = (int)str; //将数据长度赋值给CNT
//        pUartHandle.aRxBuf_1[pUartHandle.aRxBufIndex++] = str;                           /*开始存入数据*/
//        break;
//  
//    case 9:
//		pUartHandle.LenCnt_2--;
//		pUartHandle.aRxBuf_1[pUartHandle.aRxBufIndex++] = str;                           /*开始存入数据*/
